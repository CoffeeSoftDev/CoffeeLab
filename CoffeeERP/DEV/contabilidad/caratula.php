        ...
        <div id="main__content">
            ...
            <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                    ...
                    <li class='breadcrumb-item fw-bold active'>Caratula</li>
                </ol>
            </nav>
            <div class="row mb-3 d-flex justify-content-end">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <label for=""> </label>
                    <button type="button" class="btn btn-primary col-12" onclick="print()"><i class="icon-print"></i>Imprimir</button>
                </div>
            </div>
            ...
            <script src='src/js/caratula.js?t=<?php echo time(); ?>'></script>
        </div>
    </main>
</body>
