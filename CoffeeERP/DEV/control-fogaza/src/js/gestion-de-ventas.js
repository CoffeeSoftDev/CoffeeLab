...
window.link = 'ctrl/ctrl-gestion-de-ventas.php';
...
$(function () {
    ...
    ventas = new app(link, "tab-destajo");
...
class app extends Templates {
    ...
    initComponents() {
        this.tabsGestionVentas();
        this.createReporteVentas();
    }
           ...
           contenedor: [
               {
                   ...
                   novalidate: true,
                   children: [
                       { class: 'col-12 ', id: 'ingresos' },
                       { class: 'col-12 ', id: 'pagoColaboradores' }
                   ]
               },
