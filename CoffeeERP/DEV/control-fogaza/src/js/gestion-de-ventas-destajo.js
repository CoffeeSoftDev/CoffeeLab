class FormatoDestajo extends Complements {
    ...
    listDestajo() {
        ...
        fn_ajax(dtx, link, "#pagoColaboradores").then((data) => {
            ...
            $('#pagoColaboradores').rpt_json_table2({
...
function eventoTabla(idTable) {
    ...
    $("#" + idTable + " input[type='text']").on("input", function () {
        ...
        // let pagoFrances    = StrTotal($('#pago_1').text());
        // let pagoPasteleria = StrTotal($('#pago_2').text());
        // let pagoBizcocho   = StrTotal($('#pago_4').text());
        // let totalPago      = pagoFrances + pagoPasteleria + pagoBizcocho;   

    

        // $('#pago_5').html(totalPago);
