...
//     id: "myModal",
//     title: `<strong> Agregar movimiento </strong> `,
//     message: `<form  class="row row-cols-sm-2 row-col-lg-2" id="content-"  novalidate></form>`,
//   });
...
//   fn_ajax(dtx, link, "#content-ls").then((data) => {
//     $("#content-ls").rpt_json_table2({
//       data: data,
//       color_th: "bg-primary",
//     });
...
// /*-- Consultas  --*/
// function content_agregar() {
//   $("#content").simple_json_content({
//     data: json_filter,
//   });

//   $("#fz").select2({ theme: "bootstrap-5" });

//   //   $("#fz").option_select({ data:nuevo,placeholder:"-- Seleccione un producto --"});
// }
