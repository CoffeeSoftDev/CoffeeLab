    ...
    createModalForm(options) {
        ...
        let defaults = {
            ...
            btnCancel: {
              ...
              beforeSend: () => { 
                  $('#btnSuccess').prop('disabled', true).addClass('opacity-50 cursor-not-allowed');
             },
            btnSuccess: {
                opc: "button",
                id: 'btnSuccess',
            ...
            if (conf.autovalidation) {
                ...
                $("#" + conf.id).validar_contenedor({ tipo: 'text' }, (ok) => {
                    ...
                    useFetch({
                        ...
                        data: data,
                        success: (request) => {
                             $('#btnSuccess').prop('disabled', false).removeClass('opacity-50 cursor-not-allowed');
