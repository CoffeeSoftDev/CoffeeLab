window.ctrlagregar_subreceta =
  window.ctrlagregar_subreceta || "ctrl/ctrl-agregar-subreceta.php";
...
$(function () {
  ...
  $("#tbDatosAgregarSubreceta").create_table();
...
function listUDN() {
  ...
  send_ajax(datos, ctrlagregar_subreceta).then((data) => {
