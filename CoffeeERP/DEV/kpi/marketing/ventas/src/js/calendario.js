        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-3 pt-3 pb-2 flex-wrap">
            ...
            <div id="filterBar${this.PROJECT_NAME}" class="w-full sm:w-auto flex flex-col sm:flex-row items-center justify-end gap-3 mt-3 sm:mt-0">
                ...
                <button id="askAIButton"
                    onclick="calendar.openAIModal()"
                    class="mt-4 flex items-center gap-2 px-5 py-2.5 rounded-lg text-white font-medium text-sm 
                           bg-gradient-to-r from-[#3B82F6] to-[#8B5CF6] hover:from-[#2563EB] hover:to-[#7C3AED]
                           transition-all duration-300 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#8B5CF6]">
                    🤖
                ...
                const sendMessage = async () => {
                    ...
                    try {
                        ...
                        const empresasDescripcion = {
                            'BAOS': 'Es un restaurante de Mar y Tierra a las afueras de la ciudad, cuenta con una hermosa vista al mar (cerca de los barcos de la Marina) y ofrecen un estilo tropical contemporáneo, con influencias de diseño costero y rústico natural.',
                            'Quinta Tabachines': 'Es un autohotel, un lugar romántico y exclusivo de la ciudad, diseñado para ofrecer a sus huéspedes comodidad, discreción y elegancia en cada detalle. Estilo de decoración lujo moderno, toque romántico y elementos naturales.',
                            'Sonora\'s meat': 'Es un boutique de cortes finos que vende carne y es restaurante. Su estilo es industrial moderno con toques rústicos.',
                            'Fogaza': 'Es una pastelería y panadería de calidad. Su estilo es rústico artesanal con toques vintage y colonial.'
                        };

                        const descripcionEmpresa = empresasDescripcion[udnNombre] || 'Empresa del grupo con enfoque en servicio de calidad y experiencia del cliente.';
