...
class Eventos extends App {
    ...
    async newMenuLayout(id = null) {
        ...
        // Inicializar Select2 con búsqueda y estilos personalizados
        $("#selectMenu").select2({
        ...
        // Aplicar estilos personalizados al Select2
        ...
        // Inicializar Select2 para extras
        $("#selectExtra").select2({
        ...
        // Aplicar estilos personalizados al Select2 de extras
        $("#selectExtra").next(".select2-container").find(".select2-selection--single").css({
            "background-color": "#1f2937",
            "border-color": "#4b5563",
            "color": "#ffffff"
        });
