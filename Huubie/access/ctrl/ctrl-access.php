...
class Access extends MAccess {
    ...
    function company(){
        ...
        $photo = '';
        if (!empty($sql['photo'])) {
            $photo = 'https://huubie.com.mx/alpha' . $sql['photo'];
        } else {
            $photo = 'https://huubie.com.mx/alpha/src/img/df-user.png';
        }
        ...
        $sidebar = [
            [
                ...
                "submenu" => [
                    ...
                    ["text" => "Calendario", "url" => "/alpha/calendario/"],
                    ["text" => "Administración", "url" => "/alpha/catalogos/"]
                ]
            ]
        ];
